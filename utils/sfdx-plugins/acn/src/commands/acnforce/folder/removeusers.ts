...
import AcnFolderUtils from '../../../utils/force/lib/folderUtils';
...
const messages = core.Messages.loadMessages('acn', 'removeUserInFolders');
...
export default class Reconcile extends SfdxCommand {
  ...
  public async run(): Promise<any> { // tslint:disable-line:no-any
    ...
    var removeUsers = AcnFolderUtils.removeUsers(folders);
    return { "RemoveUsers": removeUsers};
  }
