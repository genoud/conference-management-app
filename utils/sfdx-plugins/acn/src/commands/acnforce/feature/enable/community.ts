...
const messages = core.Messages.loadMessages('acn', 'featureEnableCommunity');
...
export default class Community extends SfdxCommand {
  ...
  public async run(): Promise<any> { // tslint:disable-line:no-any
    ...
    await featureUtils.enableCommunity();
    //AcnFeatureUtils.enableFeature(featureName, this, this.org);
